...
public class JwtService {
    ...
    private String SECRET_KEY = "thisisasecretthatnooneornoonewillknowbyforsomehowthisllishardcodedfornowletsfixthatinpost";

    private Long EXPIRATION_TIME = 36000000L;
    ...
    private String buildToken(Map<String, Object> extraClaims, CustomUser userDetails, Long expirationTime) {
        //todo find oiut why these methods are deprecated
        return Jwts.builder()
                .claims(extraClaims)
